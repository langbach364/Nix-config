"use strict";(self.webpackChunkws_workbench=self.webpackChunkws_workbench||[]).push([[1134],{71134:(e,l,n)=>{n.r(l),n.d(l,{FileUploader:()=>ze,KeyValueEditor:()=>yn});var i=n(7560),t=n(40540),o=n(59530),s=n.n(o),a=n(78476),r=n(50297),d=n(98283),c=n(61096),u=n(69356),h=n.n(u),p=n(22833),b=n.n(p),v=n(65848),g=n(52322);let f,m,x=e=>e;const y=s().div(f||(f=x`
  position: relative;
  display: flex;
...
`),(e=>e.isDisabled?"var(--content-color-tertiary)":"var(--content-color-primary)"),(e=>e.isDisabled?"not-allowed":"pointer"),(e=>!e.isDisabled&&"border-color: var(--button-outline-hover-border-color)")),Fe=s()(we.Z)(Re||(Re=Ze`
  max-width: 100%;
`)),Pe=s().div(Ae||(Ae=Ze`
  width: 100%;
...
`));function ze(e){return(0,g.jsx)(Ce.VW,{children:(0,g.jsx)($e,(0,i.Z)({},e))})}function $e(e){const{value:l,onReset:n,id:o,label:s,name:a,multiple:r,isDisabled:c,loading:u,error:h,accept:p,autoFocus:b,onChange:v}=e,f=(0,d.Z)(e,Te),{addToast:m}=(0,Ce.ZP)();let x;if((0,t.useEffect)((()=>{h&&m({status:"error",title:We,description:h})}),[h,m]),null!=l&&l.length){const e=l.length,i=l[0],t=l.join(", "),o=e>1?`${e} files selected`:`${i}`;x=(0,g.jsx)(oe.Z,{content:t,children:(0,g.jsx)(Pe,{children:(0,g.jsx)(ke.Af,{label:o,onClick:n})})})}else x=(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(Me,(0,i.Z)({},f,{id:o,onChange:e=>{const l=e.target,n=l&&l.files;!c&&n&&(null==v||v(n))},multiple:r,disabled:c,accept:p,name:a,autoFocus:b,onClick:e=>{e.currentTarget.value="",(async e=>{e.preventDefault();const l=await(0,Ve.openVSCodeFilePicker)({title:a,canSelectMany:r,filters:{default:(null==p?void 0:p.split(","))||[]}});!c&&l&&(null==v||v(function(e){const l=new DataTransfer;for(const{path:n}of e){const{name:e}=Se(n),i=new File([e],e,{type:"file"});Object.defineProperty(i,"path",{value:n,enumerable:!0,writable:!0}),l.items.add(i)}return l.files}(l)))})(e)}})),(0,g.jsxs)(Oe,{htmlFor:o,isDisabled:c,children:[u&&(0,g.jsx)(je.Z,{size:"small"}),(0,g.jsx)("span",{children:s})]})]});return(0,g.jsx)(Fe,{direction:"column",alignItems:"center",children:x})}const Ne=()=>{const e=(0,t.useRef)(!0);return(0,t.useEffect)((()=>()=>{e.current=!1}),[]),e};let Be;const He="Select Files",Le=s()(we.Z)(Be||(Be=(e=>e)`
  padding: var(--spacing-xs);
`));function Ke(e){const{id:l,type:n,value:i,hidden:o,error:s,onFilesSelect:a,onChange:r}=e,[d,c]=(0,t.useState)(!1),u=Ne(),h=(0,t.useMemo)((()=>Array.isArray(i)?i:i?[i]:[]),[i]);return o?null:(0,g.jsx)(Le,{height:"100%",width:"100%",children:(0,g.jsx)(ze,{label:He,id:"key-value-file-uploader",multiple:!0,error:s,value:h,loading:d,onChange:e=>{a&&(c(!0),a(l,e).finally((()=>{u.current&&c(!1)})))},onReset:()=>null==r?void 0:r(n,"")})})}const Ie=e=>e.disableEdit,_e=(e,l)=>l||e.system&&!e.allowedToToggle,Ue=(e,l)=>!e.disableEdit&&!(null!=l&&l.disableToggle)||e.system;var Xe=n(95362),Ye=n(70262);let qe;const Ge=s().div(qe||(qe=(e=>e)`
...
`),(({alwaysPresent:e})=>e?"1":"0"));function Je({onClick:e,maskState:l,isVisible:n}){const i=!1===l.isMasked;return(0,g.jsx)(Ge,{role:"button",className:"toggle-mask","aria-label":"toggle-mask-row",onClick:e,alwaysPresent:i||n,children:l.isMasked?(0,g.jsx)(Xe.Z,{}):(0,g.jsx)(Ye.Z,{})})}var Qe=n(64691),el=n(48263),ll=n(80605),nl=n(59824),il=n(17282),tl=n(29225);const ol=e=>{const{onPersist:l,onReset:n,disableVariablePersistAction:i,disablePersistActionTooltip:t,disableResetActionTooltip:o,disableVariableResetAction:s}=e,a=(e=!1,l)=>{if(e){let e;switch(l){case"persist":e=t;break;case"reset":e=o}return e||"You do not have permissions to perform this action."}return null};return(0,g.jsxs)(Qe.Z,{children:[(0,g.jsx)(el.Z,{children:(0,g.jsx)(ll.Z,{icon:(0,g.jsx)(tl.Z,{size:"small"}),type:"tertiary",tooltip:"View more actions",size:"small","data-testid":"more-options-button"})}),(0,g.jsxs)(nl.Z,{placement:"bottom-end",children:[(0,g.jsx)(il.Z,{onClick:l,isDisabled:i,tooltip:a(i,"persist"),children:"Persist"}),(0,g.jsx)(il.Z,{onClick:n,isDisabled:s,tooltip:a(s,"reset"),children:"Reset"})]})]})};let sl;const al=s().div(sl||(sl=(e=>e)`
  display: flex;
  flex-direction: row;
  opacity: ${0};
  margin-right: var(--spacing-xs);
`),(({isVisible:e})=>e?"1":"0")),rl=({isHidden:e=!1,children:l,isVisible:n})=>e||!l?null:(0,g.jsx)(al,{isVisible:n,children:l});var dl=n(26246);const cl=["warning"],ul=["prevValue","prevCurrentWidth"],hl=["nextValue","nextCurrentWidth"];let pl,bl,vl,gl,fl=e=>e;const ml=s().div(pl||(pl=fl`
  display: flex;
  flex-direction: row;
  position: relative;
  flex: 0;
  ...
  background-color: ${0};
  color: ${0};
`),(e=>e.isRowFocused?"var(--background-color-secondary) !important":e.isRowSelected||e.disabled?"var(--background-color-secondary)":"inherit"),(e=>e.disabled?"var(--content-color-tertiary)":"inherit")),xl=s().div(bl||(bl=fl`
  position: relative;
  display: flex;
  flex: 1;
  min-width: 0;
  flex-direction: row;
  color: ${0};
`),(e=>e.isBlocked?"var(--content-color-tertiary)":"inherit")),yl=s().div(vl||(vl=fl`
  display: flex;
  align-items: center;
  cursor: pointer;
  border-right: var(--border-width-default) var(--border-style-solid)
...
`)),Cl=new Map;Cl.set("default",{value:ee,label:"default"}),Cl.set("secret",{value:Q,label:"secret"});const kl=[Cl.get("default"),Cl.get("secret")];function jl(e){const{index:l,value:n,onChange:o,onRemove:s,currentWidth:a,showColumns:r,allowedColumns:c,enableFiles:u,onFilesSelect:h,maskState:p,toggleMaskValue:b,hideVariableTypeDropdown:v,onPersist:f,onReset:m,onBlur:x,enableVariableSuggestions:y,optionsDropdownValues:w,isDuplicated:k}=e,j=(0,t.useRef)(o);j.current=o;let{key:V,value:E,sessionValue:D="",options:R,type:A,enabled:W=!0,description:M="",fileUploadError:O}=n;const F=A===Q?Q:ee,P=r.includes("variableType")?F:A||"text",[z,$]=(0,t.useState)(null),[N,B]=(0,t.useState)(null),H=null!==z,L=(0,t.useMemo)((()=>{var e;return null!=(e=J.find((e=>e.value===n.type)))?e:J[0]}),[n.type]),K=(0,t.useCallback)(((e,l)=>{"sessionValue"===e&&void 0!==l&&n.isSessionValueDeleted&&(null==j.current||j.current((0,i.Z)({},n,{[e]:l,isSessionValueDeleted:!1}))),null==j.current||j.current((0,i.Z)({},n,{[e]:l}))}),[n]),I=(0,t.useCallback)((e=>{(0,d.Z)(n,cl),K("enabled",e)}),[n,K]),_=(0,t.useCallback)((()=>{s&&s()}),[s]),U=(0,t.useCallback)((l=>e[`nonEditable${T(l)}s`]),[e]);function X(e){return Number(a[null==r?void 0:r.indexOf(e)])}return(0,g.jsxs)(ml,{role:"row","aria-rowindex":l,disabled:Ie(n),isRowSelected:e.isRowSelected,isRowFocused:null!==z,onMouseEnter:()=>B(!0),onMouseLeave:()=>B(!1),children:[(0,g.jsx)(C,{disabled:e.disableSorting&&e.nonEditableToggles,shouldShowCheckbox:Ue(n,e),isRowEnabled:W,onToggleEnabledState:I,isCheckboxDisabled:_e(n,e.nonEditableToggles)}),(0,g.jsxs)(xl,{isBlocked:n.disableEdit,children:[(0,g.jsx)(S,{columnWidth:X("key"),isNonEditable:U("key"),isLastColumn:r&&"key"===r[r.length-1],content:(0,g.jsx)(ce,{type:"key",value:V,currentWidth:X("key"),onFocus:()=>$("key"),onChange:K,isEditable:"key"===z,placeholder:e.keyPlaceholder,preventEnter:e.disableMultilineKey||!1,readOnly:n.disableEdit||e.nonEditableKeys,shouldFocusOnMount:!0,onBlur:()=>$(null),isDuplicated:k,actions:(0,g.jsx)(ye,{hidden:!N||!u,options:J,defaultOption:L,onChange:e=>K("type",e.value)}),indicators:(0,g.jsx)(fe,{infoTitle:n.infoTitle,info:n.info,placement:"right"}),enableVariableSuggestions:y})}),r.includes("variableType")&&(0,g.jsx)(S,{columnWidth:X("variableType"),isNonEditable:U("variableType"),isLastColumn:r&&"variableType"===r[r.length-1],content:(!v||e.nonEditableVariableTypes)&&(0,g.jsx)(wl,{isRowFocused:H,tabIndex:-1,isDisabled:e.nonEditableVariableTypes,onChange:async n=>{const{disableAllVariablesSync:i=!1,disableSecretVariablesSync:t}=e;if(A===n.value)return;if(i||!t&&n.value===Q||t&&n.value===Q&&!E)return K("type",n.value),void(b&&b(l));const o=dl.Modals.getModals(),s=await o.showWarningDialog({uid:"kv-editor-variable-type-change-confirmation",subject:`Change ${V}'s type to ${n.value}?`,message:"This will reveal the hidden values in plain text everywhere in the app for all team members",options:[{title:"Cancel",isDefaultOnDismiss:!0},{title:"Change type",isPrimary:!0}]});return s&&"Change type"===s.title?(K("type",n.value),void(b&&b(l))):void 0},options:kl,value:Cl.get(P),isClearable:!1,isSearchable:!1,menuWidth:100})}),r.includes("value")&&(0,g.jsx)(S,{columnWidth:X("value"),isNonEditable:U("value"),isLastColumn:r&&"value"===r[r.length-1],content:(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(ce,{hidden:"file"===A,type:"value",value:E,currentWidth:X("value"),onFocus:()=>$("value"),onChange:K,isEditable:"value"===z,placeholder:e.valuePlaceholder,preventEnter:e.disableMultilineValue||!1,readOnly:n.disableEdit||e.nonEditableValues,shouldFocusOnMount:!0,onBlur:()=>("value",$(null),void(x&&x("value",n))),editorType:A,maskState:p,enableVariableSuggestions:y}),(0,g.jsx)(Ke,{hidden:"file"!==A,id:l,type:"value",value:E,error:O,onChange:K,onFilesSelect:h})]})}),r.includes("description")&&(0,g.jsx)(S,{columnWidth:X("description"),isNonEditable:U("description"),isLastColumn:r&&"description"===r[r.length-1],content:(0,g.jsx)(ce,{type:"description",value:M,onChange:K,placeholder:e.descriptionPlaceholder,isEditable:"description"===z,currentWidth:X("description"),onFocus:()=>$("description"),readOnly:n.disableEdit||e.nonEditableDescriptions,shouldFocusOnMount:!0,onBlur:()=>$(null)})}),r.includes("sessionValue")&&(0,g.jsx)(S,{columnWidth:X("sessionValue"),isNonEditable:U("sessionValue"),isLastColumn:r&&"sessionValue"===r[r.length-1],content:(0,g.jsx)(ce,{type:"sessionValue",value:D,onChange:K,isEditable:"sessionValue"===z,placeholder:n.isSessionValueDeleted?"[Deleted]":e.sessionValuePlaceholder,preventEnter:e.disableMultilineValue||!1,currentWidth:X("sessionValue"),onFocus:()=>$("sessionValue"),readOnly:n.disableEdit||e.nonEditableSessionValue,shouldFocusOnMount:!0,onBlur:()=>$(null),editorType:A,maskState:p,enableVariableSuggestions:y})}),r.includes("options")&&(0,g.jsx)(S,{columnWidth:X("options"),isNonEditable:U("options"),isLastColumn:r&&"options"===r[r.length-1],content:(0,g.jsx)(wl,{isRowFocused:H,tabIndex:-1,onChange:e=>K("options",e),options:w,value:R,isClearable:!1,isSearchable:!1,menuWidth:100})}),(0,g.jsx)(yl,{children:((null==r?void 0:r.includes("value"))||(null==r?void 0:r.includes("description"))||(null==r?void 0:r.includes("sessionValue")))&&!e.isRowSelected&&!e.value.disableEdit&&(0,g.jsxs)(g.Fragment,{children:[P===Q&&(0,g.jsx)(Je,{isVisible:N,maskState:p,onClick:()=>b(l)}),(0,g.jsxs)(rl,{isHidden:H,isVisible:N,children:[!e.disableDelete&&(0,g.jsx)(Z,{onClick:_}),!e.disableVariableRowDropdown&&c.includes("sessionValue")&&(0,g.jsx)(ol,{onPersist:f,onReset:m,disableVariablePersistAction:e.disableVariablePersistAction||e.disableSecretVariablesSync&&P===Q,disablePersistActionTooltip:e.disablePersistActionTooltip,disableVariableResetAction:e.disableVariableResetAction||e.disableSecretVariablesSync&&P===Q,disableResetActionTooltip:e.disableResetActionTooltip})]})]})})]})]})}const Vl=(0,t.memo)(jl,((e,l)=>{const{prevValue:n,prevCurrentWidth:i}=e,t=(0,d.Z)(e,ul),{nextValue:o,nextCurrentWidth:s}=l,a=(0,d.Z)(l,hl);return!!h()(n,o)&&(!!h()(t,a)&&!!E(i,s))}));var Sl=n(49437),Tl=n(80047);const El=["values","disableSorting","onChange","onRemove","disableDelete","disableCreate","disableToggle","keyPlaceholder","valuePlaceholder","descriptionPlaceholder","disableVariableRowDropdown","currentWidth","maskStatesMap","toggleMaskValue","onPersist","onReset","onBlur","filteredIndices","searchValue","enableScroll","duplicateWarningsMap"];let Dl;const Rl=s().div(Dl||(Dl=(e=>e)`
  display: flex;
  flex: 1;
...
`),(({enableScroll:e})=>e&&"overflow: overlay;"));function Al(e){let{values:l,disableSorting:n,onChange:o,onRemove:s,disableDelete:a,disableCreate:r,disableToggle:c,keyPlaceholder:u,valuePlaceholder:h,descriptionPlaceholder:p,disableVariableRowDropdown:b,currentWidth:v,maskStatesMap:f,toggleMaskValue:m,onPersist:x,onReset:y,onBlur:w,filteredIndices:C,searchValue:k,enableScroll:j,duplicateWarningsMap:V}=e,S=(0,d.Z)(e,El);const T=(0,t.useCallback)(((e,l)=>{o&&o(e,l)}),[o]),E=(0,t.useCallback)((e=>{s&&s(e)}),[s]),D=k&&C?C.map((e=>l[e])):l;return(0,g.jsx)(Rl,{enableScroll:j,children:k&&0===D.length?(0,g.jsx)("div",{className:"key-value-form-editor-sortable",children:(0,g.jsx)(Sl.Z,{title:"No results found",children:(0,g.jsx)(Tl.Z,{name:"illustration-search"})})}):D&&D.map(((e,t)=>{var o,s,d;const C=e.id===(null==l?void 0:l.length)-1;return(0,g.jsx)(Vl,(0,i.Z)({index:null!=(o=e.id)?o:t,selectableKey:e.id,value:e,onChange:l=>T(e.id,l),onRemove:()=>E(e.id),onPersist:()=>{return l=e.id,void(x&&x(l));var l},onReset:()=>{return l=e.id,void(y&&y(l));var l},onBlur:(l,n)=>((e,l,n)=>{w&&w(e,l,n)})(e.id,l,n),disableSorting:n||C,disableToggle:c||C&&!r,disableDelete:a||C&&!r,disableVariableRowDropdown:b||C&&!r,keyPlaceholder:C&&u,valuePlaceholder:C&&h,descriptionPlaceholder:C&&p,hideVariableTypeDropdown:!r&&C,currentWidth:v,maskState:!(!r&&C)&&(f&&f[e.id]||{isMasked:e.type===Q}),isDuplicated:V&&V[e.id].isOverridden,toggleMaskValue:m},S),null!=(s=null==(d=e.id)?void 0:d.toString())?s:t)}))})}var Zl=n(70355);function Wl(e,l=100){return e/l*100}function Ml(e,l=2){return Math.round(e*Math.pow(10,l))/Math.pow(10,l)}let Ol;const Fl=500,Pl=s().div(Ol||(Ol=(e=>e)`
  height: 32px;
  width: 16px;
  margin-left: -8px;
  background-color: transparent;
  ...
  cursor: col-resize;
  z-index: 1;
`),(e=>e.left)),zl=e=>{const{showColumns:l,currentWidth:n,prevColumn:i,nextColumn:o,parentWidth:s=Fl,handleResize:a}=e,r=(0,t.useCallback)((e=>{const i=null==l?void 0:l.indexOf(e);if(-1===i)return 0;let t=0;for(let e=0;e<=i;e++)t+=n[e];return Ml(t)}),[l,n]),d=(0,t.useMemo)((()=>{const e=r(l[(null==l?void 0:l.indexOf(i))-1])+Wl(100,s),n=r(o)-Wl(100,s);return{min:Ml(e),max:Ml(n)}}),[i,o,l,s,r]),c=(0,t.useCallback)((e=>Number.isNaN(d.min)||Number.isNaN(d.max)?e:Ml(Math.min(Math.max(e,d.min),d.max))),[d]),u=(0,t.useCallback)(((e,t)=>{const r=c(Wl(t.x,s));if(r==d.min||r==d.max)return;const u=[...n],h=n[l.indexOf(i)]+t.deltaX/s*100,p=n[l.indexOf(o)]-t.deltaX/s*100;u[null==l?void 0:l.indexOf(i)]=Ml(h,2),u[null==l?void 0:l.indexOf(o)]=Ml(p,2),null==a||a(u)}),[s,n,l,d]);return(0,g.jsx)(Zl.DraggableCore,{onDrag:u,children:(0,g.jsx)(Pl,{left:c(r(i))})})};let $l,Nl,Bl,Hl,Ll,Kl,Il,_l,Ul=e=>e;const Xl=s().div($l||($l=Ul`
  font-size: var(--text-size-m);
...
`)),Gl=s().div(Hl||(Hl=Ul`
  ...
  border-right: var(--border-width-default) var(--border-style-solid)
    var(--border-color-default);
  background-color: ${0};
`),(e=>e.nonEditableToggles?"var(--background-color-secondary);":"inherit")),Jl=s().div(Ll||(Ll=Ul`
  height: 30px;
  width: 0;
  position: absolute;
...
`)),ln=s().div(_l||(_l=Ul`
  ...
  margin: var(--spacing-zero);
  background-color: ${0};
`),(e=>e.isLastColumn?`0 1 ${e.columnWidth}%`:`0 0 ${e.columnWidth}%`),(e=>e.isNonEditable?"var(--background-color-secondary)":"inherit")),nn=new Map;nn.set("persistAll",{disabled:"You do not have permissions to perform this action.",default:"Persisting all values will replace all initial values with the current values of the variables."}),nn.set("resetAll",{default:"Resetting all values will replace all current values with the initial values of the variables."});const tn=(e,l,n)=>{let i;var t,o;return l&&(i=n||(null==(t=nn.get(e))?void 0:t.disabled)),i||(i=null==(o=nn.get(e))?void 0:o.default),i},on=({allowedColumns:e,persistAll:l,disableVariablePersistAction:n,disablePersistActionTooltip:i,resetAll:t,disableVariableResetAction:o,disableResetActionTooltip:s})=>e.includes("sessionValue")?(0,g.jsx)(Yl,{children:(0,g.jsxs)(Qe.Z,{closeOnSelect:!1,children:[(0,g.jsx)(el.Z,{"data-testid":"key-value-editor-more-actions-button",children:(0,g.jsx)(ll.Z,{size:"small",icon:(0,g.jsx)(tl.Z,{size:"small"}),type:"tertiary",tooltip:"View more actions","data-testid":"more-options-button-column-header"})}),(0,g.jsxs)(nl.Z,{children:[(0,g.jsx)(il.Z,{onClick:l,isDisabled:n,tooltip:tn("persistAll",n,i),children:"Persist all"}),(0,g.jsx)(il.Z,{onClick:t,isDisabled:o,tooltip:tn("resetAll",o,s),children:"Reset all"})]})]})}):null;function sn(e){const{showColumns:l,currentWidth:n,handleWidthChange:i,keyHeading:o,valueHeading:s,descriptionHeading:a,sessionHeading:r,typeHeading:d,optionsHeading:c,allowedColumns:u,persistAll:h,resetAll:p,disableVariablePersistAction:b,disablePersistActionTooltip:v,disableVariableResetAction:f,disableResetActionTooltip:m}=e,x=(0,t.useRef)(null),[y,w]=(0,t.useState)(null);(0,t.useEffect)((()=>{const e=new ResizeObserver((e=>{w(e[0].contentRect.width)})),l=x.current;return e.observe(l),()=>{e.unobserve(l)}}),[]);const C=(0,t.useCallback)((l=>e[`nonEditable${T(l)}s`]),[e]),k=(0,t.useCallback)((e=>Number(n[null==l?void 0:l.indexOf(e)])),[l,n]);return(0,g.jsx)(Xl,{role:"rowgroup",children:(0,g.jsxs)(ql,{role:"row",children:[(0,g.jsx)(Gl,{children:(0,g.jsx)(Jl,{})}),(0,g.jsxs)(Ql,{ref:x,children:[(0,g.jsx)(ln,{type:"key",role:"columnheader",columnWidth:k("key"),isNonEditable:C("key"),isLastColumn:l&&"key"===l[l.length-1],children:(0,g.jsx)(en,{children:o||"Key"})}),(null==l?void 0:l.includes("variableType"))&&(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(zl,{handleResize:i,showColumns:l,currentWidth:n,prevColumn:"key",nextColumn:"variableType",parentWidth:y}),(0,g.jsx)(ln,{type:"variableType",role:"columnheader",columnWidth:k("variableType"),isNonEditable:C("variableType"),isLastColumn:l&&"variableType"===l[l.length-1],children:(0,g.jsx)(en,{children:d||"Type"})})]}),(null==l?void 0:l.includes("value"))&&(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(zl,{handleResize:i,showColumns:l,currentWidth:n,prevColumn:l.includes("variableType")?"variableType":"key",nextColumn:"value",parentWidth:y}),(0,g.jsx)(ln,{type:"value",role:"columnheader",columnWidth:k("value"),isNonEditable:C("value"),isLastColumn:l&&"value"===l[l.length-1],children:(0,g.jsx)(en,{children:s||"Value"})})]}),(null==l?void 0:l.includes("description"))&&(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(zl,{handleResize:i,showColumns:l,currentWidth:n,prevColumn:"value",nextColumn:"description",parentWidth:y}),(0,g.jsx)(ln,{type:"description",role:"columnheader",columnWidth:k("description"),isNonEditable:C("description"),isLastColumn:l&&"description"===l[l.length-1],children:(0,g.jsx)(en,{children:a||"Description"})})]}),(null==l?void 0:l.includes("sessionValue"))&&(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(zl,{handleResize:i,showColumns:l,currentWidth:n,prevColumn:"value",nextColumn:"sessionValue",parentWidth:y}),(0,g.jsx)(ln,{type:"sessionValue",role:"columnheader",columnWidth:k("sessionValue"),isNonEditable:C("sessionValue"),isLastColumn:l&&"sessionValue"===l[l.length-1],children:(0,g.jsx)(en,{children:r||"Current value"})})]}),u.includes("sessionValue")&&(0,g.jsx)(on,{allowedColumns:u,persistAll:h,resetAll:p,disablePersistActionTooltip:v,disableResetActionTooltip:m,disableVariablePersistAction:b,disableVariableResetAction:f}),(null==l?void 0:l.includes("options"))&&(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(zl,{handleResize:i,showColumns:l,currentWidth:n,prevColumn:"value",nextColumn:"options",parentWidth:y}),(0,g.jsx)(ln,{type:"options",role:"columnheader",columnWidth:k("options"),isNonEditable:C("options"),isLastColumn:l&&"options"===l[l.length-1],children:(0,g.jsx)(en,{children:c||"Options"})})]})]})]})})}const an=["defaultValue","entityType","values","onChange","showColumns","nonEditableKeys","nonEditableValues","nonEditableDescriptions","nonEditableToggles","nonEditableOptions","keyHeading","valueHeading","sessionHeading","optionsHeading","optionsTooltip","nonEditableVariableTypes","hideBulkOptions","maskStatesMap","toggleMaskValue","initialColumnWidths","disableVariablePersistAction","disableVariableResetAction","disableSecretVariablesSync","disablePersistActionTooltip","disableResetActionTooltip","onDeleteRow","disallowDuplicates"];let rn;const dn=s().div(rn||(rn=(e=>e)`
  display: flex;
  flex: 1;
  flex-direction: column;
  border-top: thin solid var(--border-color-default);
  min-height: 0;
`));function cn(e){let{defaultValue:l="",entityType:n,values:o,onChange:s,showColumns:a,nonEditableKeys:r,nonEditableValues:c,nonEditableDescriptions:u,nonEditableToggles:h,nonEditableOptions:p,keyHeading:b,valueHeading:v,sessionHeading:f,optionsHeading:m,optionsTooltip:x,nonEditableVariableTypes:y,hideBulkOptions:w,maskStatesMap:C,toggleMaskValue:k,initialColumnWidths:j,disableVariablePersistAction:V,disableVariableResetAction:S,disableSecretVariablesSync:T,disablePersistActionTooltip:E,disableResetActionTooltip:D,onDeleteRow:R,disallowDuplicates:A}=e,Z=(0,d.Z)(e,an);const W={showColumns:a,allowedColumns:Z.allowedColumns,nonEditableKeys:r,nonEditableValues:c,nonEditableDescriptions:u,nonEditableToggles:h,nonEditableOptions:p,hideBulkOptions:w},M=(0,t.useRef)(s);M.current=s;const[O,F]=(0,t.useState)(function(e,l){let n;return l?n=l:(n=new Array(e.length).fill(Math.floor(100/e.length)),n[n.length-1]=n.at(-1)+(100-n.reduce(((e,l)=>e+l)))),n}(a,j)),P=(0,t.useCallback)(((e,i={})=>{let t="text";"environment"!==n&&"globals"!==n||(t="default"),"collection"===n&&(t="string");const o={key:i.key||l,value:i.value||l,description:i.description||l,type:i.type||t,id:e};return Z.allowedColumns.includes("sessionValue")&&(o.sessionValue=i.sessionValue||null),Z.disableToggle||(o.enabled=!0),o}),[l,Z.disableToggle,n,Z.allowedColumns]),z=(0,t.useCallback)((()=>{if(o.length>0){var e=null==o?void 0:o.reduce((function(e,l){return e.id>=l.id?e:l}),{});return l=e,[Object,Array].includes((l||{}).constructor)&&0===Object.entries(l||{}).length?0:e.id+1}var l;return 0}),[o]),$=(0,t.useCallback)(((e,l)=>{const n=[...o],t=n.length===e?[...n,P(z(),l)]:n.map((n=>n.id===e?(0,i.Z)({},n,l):(0,i.Z)({},n)));null==M.current||M.current(t)}),[o,P,z]),N=(0,t.useCallback)((e=>{const l=[...o],n=null==l?void 0:l.filter(((l={})=>l.id!==e));R&&R(e),null==M.current||M.current(n)}),[o,R]),B=(0,g.jsx)(sn,(0,i.Z)({},W,{keyHeading:b||"Key",valueHeading:v||"Value",sessionHeading:f||"Current value",optionsHeading:m||"Options",optionsTooltip:x,nonEditableVariableTypes:y,handleWidthChange:F,currentWidth:O,persistAll:()=>{if(V)return;let e=!1;const l=o.reduce(((l,n)=>{const t=n.enabled?n.sessionValue:n.value;return n.isSessionValueDeleted?(e=!0,l):(!e&&(e=!(T&&n.type===Q)),T&&n.type===Q?l.push(n):l.push((0,i.Z)({},n,{value:t})),l)}),[]);e&&(null==M.current||M.current(l))},resetAll:()=>{if(S)return;let e=!1;const l=o.map((l=>{const n=l.enabled?l.value:l.sessionValue;return T&&l.type===Q?l:(e=!0,(0,i.Z)({},l,{sessionValue:n,isSessionValueDeleted:!1}))}));e&&(null==M.current||M.current(l))},disableVariablePersistAction:V,disableVariableResetAction:S,disablePersistActionTooltip:E,disableResetActionTooltip:D})),H=(0,t.useMemo)((()=>Z.disableCreate?o:[...o,P(z())]),[o,Z.disableCreate,P,z]),L=(0,t.useMemo)((()=>A?H.map(((e,l)=>{if(e.enabled&&""!==e.key)for(let n=l+1;n<H.length;n++){const l=H[n];if(e.key===l.key&&l.enabled&&""!==l.key)return(0,i.Z)({},e,{isOverridden:!0})}return(0,i.Z)({},e,{isOverridden:!1})})):null),[H,A]);return(0,g.jsxs)(dn,{children:[o.length>0||!Z.disableCreate?B:null,(0,g.jsx)(Al,(0,i.Z)({},W,Z,{nonEditableVariableTypes:y,values:H,onChange:$,onRemove:N,currentWidth:O,maskStatesMap:C,toggleMaskValue:k,onPersist:e=>{if(V)return;let l=!1;const n=o.reduce(((n,t)=>{if(t.id===e){if(t.isSessionValueDeleted)return l=!0,n;T&&t.type===Q?n.push(t):(l=!0,n.push((0,i.Z)({},t,{value:t.sessionValue})))}else n.push(t);return n}),[]);l&&(null==M.current||M.current(n))},onReset:e=>{if(S)return;let l=!1;const n=o.map((n=>n.id!==e||T&&n.type===Q?n:(l=!0,(0,i.Z)({},n,{sessionValue:n.value,isSessionValueDeleted:!1}))));l&&(null==M.current||M.current(n))},onBlur:(e,l,n)=>{const t=o.findIndex((l=>l.id===e)),s=-1!==t&&o[t].sessionValue;let a;"value"===l&&-1!==t&&null===s&&n.value&&(a=[...o],a[t]=(0,i.Z)({},n,{sessionValue:n.value}),null==M.current||M.current(a))},disableVariablePersistAction:V,disableVariableResetAction:S,disableSecretVariablesSync:T,disablePersistActionTooltip:E,disableResetActionTooltip:D,duplicateWarningsMap:L}))]})}var un=n(68206);const hn=W(((e,...l)=>e(...l)),100),pn=({onSearchValueChange:e})=>{const[l,n]=(0,t.useState)("");return(0,g.jsx)("div",{className:"search-variable",children:(0,g.jsx)(un.Z,{placeholder:"Filter variables",value:l,type:"search",onChange:l=>{n(l.target.value),hn(e,l.target.value)},onClear:()=>{n(""),e("")},prefix:!0,name:"filter-values"})})};function bn(e,l){try{const n=(0,se.castNonStringTypesToString)(e),i=(0,se.castNonStringTypesToString)(l),t=n.toLowerCase(),o=i.toLowerCase();return t.indexOf(o)}catch(n){return console.error("PatterSearch~caseInsensitiveIndexof: Failed with error",n,e,l),-1}}let vn;const gn=s().div(vn||(vn=(e=>e)`
...
`),(({enableScroll:e})=>e&&"height: 100%;")),fn=(e,l)=>!l||!(!e.key||-1===bn(e.key,l))||"secret"!==e.type&&(!(!e.value||-1===bn(e.value,l))||!(!e.sessionValue||-1===bn(e.sessionValue,l))||void 0),mn=(e,l)=>{if(!l)return null;const n=[];for(const[i,t]of e.entries())fn(t,l)&&n.push(i);return n},xn=(0,r.observer)((function(e){const{values:l,onChange:n,tableName:o,disallowDuplicates:s,allowedColumns:r,showColumns:d,onColumnToggle:c,keyPlaceholder:u,valuePlaceholder:h,maskStatesMap:p,toggleMaskValue:b,initialColumnWidths:v,enableFiltering:f=!1,enableScroll:m,isDirty:x=!1}=e,[y,w]=(0,t.useState)([]),[C,k]=(0,t.useState)(""),[j,V]=(0,t.useState)(null),S=(0,t.useRef)(x),T=(0,t.useCallback)((e=>{if(0===y.length)return!0;e.preventDefault();const i=null==l?void 0:l.filter(((e,l)=>!(null!=y&&y.includes(l))));y.sort(),0!==y[0]&&(y.length,l.length),w([]),n(i)}),[l,n,y]),E=(0,t.useCallback)((()=>{y.length>0&&w([])}),[y]),D=(0,t.useMemo)((()=>{let e=0;return(0,a.computed)((()=>null==l?void 0:l.map((l=>(0,i.Z)({},l,{id:e++})))))}),[l]).get();return(0,t.useEffect)((()=>{const e=mn(D,C);V(e)}),[C]),(0,t.useEffect)((()=>{if(S.current&&!x){const e=mn(D,C);V(e)}S.current=x}),[x]),(0,g.jsxs)(gn,{role:"table","aria-label":o,enableScroll:m,children:[f&&(0,g.jsx)(pn,{onSearchValueChange:k}),(0,g.jsx)(cn,(0,i.Z)({},e,{disallowDuplicates:s,onChange:n,values:D,selectedRows:y,deleteSelectedRows:T,onBeforeInput:E,allowedColumns:r,showColumns:d,onColumnToggle:c,keyPlaceholder:void 0===u?"Key":u,valuePlaceholder:void 0===h?"Value":h,descriptionPlaceholder:"Description",maskStatesMap:p,toggleMaskValue:b,initialColumnWidths:v,filteredIndices:j,searchValue:C,onDeleteRow:e=>{if(!C)return;const l=((e,l)=>{const n=[],i=new Set(l);let t=0;for(const l of e)i.has(l)?t++:n.push(l-t);return n})(j,[e]);V(l)}})),(0,g.jsx)(dl.Modals.Ui.ModalDialog,{uid:"kv-editor-variable-type-change-confirmation"})]})})),yn=e=>(0,g.jsx)(xn,(0,i.Z)({},e))}}]);
//# sourceMappingURL=1134.6cac6ededed144a4.js.map