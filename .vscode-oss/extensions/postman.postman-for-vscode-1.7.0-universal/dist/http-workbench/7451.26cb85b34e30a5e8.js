...
`),(e=>e.isHardFocused?"0 0 0 2px var(--base-color-info)":"none")),ea=c().div(Yr||(Yr=Xr`
  display: flex;
  flex-direction: column;
  width: 100%;
`)),ta=c().div(Gr||(Gr=Xr`
...
`)),ra=(0,o.observer)((()=>{const{url:e,setUrl:t}=(0,$r.I)(),[,r]=Kr(),{workspaceId:s}=(0,k.useParams)(),o=Nr(),{data:n=[]}=(0,Ur.useHistoryUrls)({workspaceId:s,pageSize:10,filterFn:e=>"request"===e.type}),{transformCurl:i,hydrateStore:l,isValidCurl:d}=(()=>{const e=(0,f.x)();return{transformCurl:async e=>await(0,Wr.transformCurlToRequest)(e),isValidCurl:async e=>{var t;const r=await(0,Wr.checkImportFormat)(e);return!r.err&&!(null==r||!r.ok||"curl"!==(null==(t=r.val)?void 0:t.format))},hydrateStore:e.hydrateStore.bind(e)}})(),[c,u]=(0,a.useState)(!1),[h,p]=(0,a.useState)(!1),m=async e=>{var a;const s=null==(a=e.clipboardData)?void 0:a.getData("text");await d(s)&&(p(!0),setTimeout((async()=>{const e=await i(s);e&&0!==Object.keys(e).length?(t(e.url),r(e.headerData),l(e),p(!1)):p(!1)}),500))},g=(0,Hr.usePostmanInputFeatureFlag)(),{rename:v}=(0,T.useAdditionalRouteContext)();return g?(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(Hr.URLInput,{value:e,onChange:t,suggestions:n,placeholder:"Enter URL or paste text",onEnter:o,onPaste:m,autofocus:!e&&!v}),h&&!c&&(0,D.jsx)(ta,{"data-testid":"animation-gradient-container",children:(0,D.jsxs)("div",{className:"request-editor__main__url-gradient",children:[(0,D.jsx)("div",{className:"request-editor__main__url-gradient-left"}),(0,D.jsx)("div",{className:"request-editor__main__url-gradient-right"})]})})]}):(0,D.jsxs)(ea,{children:[(0,D.jsx)(Jr,{value:e,onChange:t,suggestions:n,placeholder:"Enter URL or paste text",onPaste:m,setIsHardFocused:u,isHardFocused:c}),h&&!c&&(0,D.jsx)(ta,{"data-testid":"animation-gradient-container",children:(0,D.jsxs)("div",{className:"request-editor__main__url-gradient",children:[(0,D.jsx)("div",{className:"request-editor__main__url-gradient-left"}),(0,D.jsx)("div",{className:"request-editor__main__url-gradient-right"})]})})]})}));ra.displayName="observer(RequestURLInput)";const aa=ra;var sa=r(74269);let oa;const na=c()(sa.Z)(oa||(oa=(e=>e)`
...
`),(e=>`${e.theme["border-radius-default"]} 0 0 ${e.theme["border-radius-default"]}`),(e=>`${e.theme["border-width-default"]} ${e.theme["border-style-solid"]} ${e.theme["border-color-default"]}`),(e=>e.theme["border-color-default"]),(e=>e.theme["background-color-primary"]),(e=>`${e.theme["border-width-default"]} ${e.theme["border-style-solid"]} ${e.theme["request-url-highlight-border-color"]}`),(e=>e.theme["request-url-highlight-border-color"]),(e=>{var t;return e.value&&e.theme[null==(t=Mr.Is[e.value.label])?void 0:t.color]})),ia=e=>(0,D.jsx)(h.ZP,{color:null==e?void 0:e.color,typographyStyle:{fontWeight:"text-weight-medium"},isTruncated:!0,children:null==e?void 0:e.label}),la=(0,o.observer)((()=>{const[e,t]=(()=>{const e=(0,f.x)();return[e.method,e.setMethod]})(),[r,s]=(0,a.useState)({label:e,value:e}),o=Object.values((0,J.Z)({},Mr.Is,Mr.WJ)),n=(0,a.useRef)(null),i=e=>{e.target.value&&s(null)};return(0,a.useEffect)((()=>{(e=>{s({label:e,value:e})})(e)}),[e]),(0,a.useEffect)((()=>{const e=n.current,t=null==e?void 0:e.querySelector(`#${Mr._A}`);return null==t||t.addEventListener("keyup",i),()=>{null==t||t.removeEventListener("keyup",i)}}),[]),(0,D.jsx)("div",{ref:n,"data-testid":"method-dropdown-container",children:(0,D.jsx)(na,{id:Mr._A,onChange:e=>{e?t(e.value):s(null)},options:o,triggerWidth:115,menuMinWidth:115,placeholder:"METHOD",menuPlacement:"bottom-start",allowCreateNewOption:!0,isClearable:!0,value:r,customOptionComponent:ia,onClose:()=>{r||s({label:e,value:e})}})})}));let da,ca,ua,ha=e=>e;const{PerformanceMarkPaint:pa}=kr.perfComponents,ma=c().form(da||(da=ha`
  display: flex;
  flex-direction: row;
  align-items: center;
  box-sizing: border-box;
  padding: ${0};
`),(e=>e.theme["spacing-s"])),ga=c().div(ca||(ca=ha`
  display: flex;
  flex-direction: row;
  height: 40px;
  flex: 1;
  box-sizing: border-box;
  padding-right: ${0};
`),(e=>e.theme["spacing-s"])),va=c()(p.Z)(ua||(ua=ha`
  height: 40px;
  width: 100px;
  background-color: ${0};
  font-size: ${0};
...
`),(e=>e.theme["base-color-info"]),(e=>e.theme["text-size-l"]),(e=>e.theme["text-weight-medium"]),(e=>e.theme["content-color-constant"]),(e=>e.theme["highlight-background-color-info"]),(e=>e.theme["base-color-info"]),(e=>e.theme["content-color-constant"]),(e=>e.theme["highlight-background-color-info"])),ba=(0,o.observer)((()=>{const e=Vr(),{url:t}=(0,$r.I)(),{addToast:r}=(0,n.ZP)(),a=e?"Sending...":"Send",s=Nr(),o=e=>{if(!t)return null==e||e.preventDefault(),r(Mr.tU.EMPTY_URL),!1;s()};return ft({ctrlKey:!0,keys:"Enter",callback:o}),(0,D.jsx)(va,{type:"primary",text:(0,D.jsx)("span",{id:"send-request-button-title","aria-label":"Send Request",children:a}),isDisabled:e,onClick:o})})),fa=()=>{const e=xr(),t=Nr(),r=(()=>{const e=(0,f.x)(),{data:t}=(0,K.useActiveEnvironment)();return()=>{e.isExampleRequestSent||e.sendRequest({activeEnvironment:t}),e.setExampleRequestSent()}})(),s=!!(0,f.x)().exampleMeta,{autoRunRequest:o}={autoRunRequest:(0,f.x)().autoRunRequest},n=(0,a.useCallback)((e=>{e.preventDefault(),t()}),[t]);return(0,a.useEffect)((()=>{s&&r()}),[]),(0,a.useEffect)((()=>{o&&t()}),[]),(0,D.jsxs)(ma,{onSubmit:n,children:[(0,D.jsxs)(ga,{children:[(0,D.jsx)(la,{}),(0,D.jsx)(aa,{})]}),(0,D.jsx)(pa,{markName:Tr,callback:()=>{return t=e,performance.measure(wr,{},Tr),void(0,kr.sendMeasureEvent)({name:wr,label:t,entityType:Sr});var t},children:(0,D.jsx)(ba,{})})]})};var ya=r(15761),xa=r(27366),ka=r(71132),Sa=r(27162),wa=r(5246),ja=r(19956);const Ta=()=>{const e=(0,f.x)().urlStore;return{queryParams:e.queryParams,updateQueryParams:e.updateQueryParams}},Ca=()=>({queryParamsToShow:(0,f.x)().urlStore.allQueryParams}),Ea=()=>{const e=(0,f.x)().urlStore;return{pathVariables:e.pathVariables,updatePathVariables:e.updatePathVariables}};let Ia,qa,Pa=e=>e;const Ra=c().div(Ia||(Ia=Pa`
  display: flex;
  flex-direction: column;
...
`),(e=>e.theme["size-m"]),(e=>e.theme["text-size-m"]),(e=>e.theme["content-color-secondary"]),(e=>e.theme["text-weight-medium"])),Za=c()(u.Z)(qa||(qa=Pa`
  flex: 1;
  overflow: auto;
`)),Da=(0,o.observer)((()=>{const{updateQueryParams:e}=Ta(),{queryParamsToShow:t}=Ca(),{pathVariables:r,updatePathVariables:a}=Ea(),s=r&&r.length>0;return(0,D.jsxs)(Za,{direction:"column",children:[(0,D.jsx)(Ra,{children:"Query Params"}),(0,D.jsx)(ja.KeyValueEditor,{tableName:"Query Params",allowedColumns:["key","value"],showColumns:["key","value"],values:t,onChange:e,disableSorting:!1,nonEditableKeys:!1,nonEditableValues:!1,nonEditableToggles:!1,disableBulkEdit:!0,disableMultilineKey:!0,disableMultilineValue:!0,enableVariableSuggestions:!0}),s&&(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(Ra,{children:"Path Variables"}),(0,D.jsx)(ja.KeyValueEditor,{tableName:"Path Variables",allowedColumns:["key","value"],showColumns:["key","value"],values:r,onChange:a,disableSorting:!1,nonEditableKeys:!0,nonEditableValues:!1,nonEditableToggles:!1,disableBulkEdit:!0,disableDelete:!0,disableCreate:!0,disableToggle:!0,disableMultilineKey:!0,disableMultilineValue:!0,enableVariableSuggestions:!0})]})]})}));var Aa=r(31987),La=r(38163);function za(){const e=(0,f.x)(),t=(0,a.useRef)((t=>e.setRawEditorState({language:t})));return[e.rawEditorState.language,t.current]}function _a(e){const t=(0,f.x)(),r=(0,a.useRef)(t.rawEditorState.beautify),s=t.rawEditorState.beautify,o=(0,a.useRef)((()=>t.setRawEditorState({beautify:[]})));return(0,a.useEffect)((()=>{r.current!==s&&e&&(r.current=s,e())}),[s,e]),o.current}let Ba,Oa,Fa=e=>e;const Ma=c().div(Ba||(Ba=Fa`
  flex: 1;
  display: flex;
  justify-content: space-between;
`)),$a=c()(sa.Z)(Oa||(Oa=Fa`
...
`));function Na({showBeautifyBtn:e,defaultValue:t,options:r,onChange:s}){const[o,n]=(0,a.useState)(t),i=_a();return(0,a.useEffect)((()=>{n(t)}),[t]),(0,D.jsxs)(Ma,{"data-testid":"raw-body-action-container",children:[(0,D.jsx)($a,{value:o,onChange:e=>{n(e),null==s||s(e.value)},options:r,isClearable:!1,isSearchable:!1,triggerType:"tertiary",triggerWidth:"auto",viaPortal:!0}),(0,D.jsx)("div",{children:e?(0,D.jsx)(p.Z,{onClick:i,text:"Beautify"}):null})]})}const Va=[{value:"text",label:"Text"},{value:"javascript",label:"JavaScript"},{value:"json",label:"JSON"},{value:"html",label:"HTML"},{value:"xml",label:"XML"}],Ha=[...Va],Ua=e=>e!==Va[0].value,Wa=(0,o.observer)((function(){const[e,t]=za();return(0,D.jsx)(Na,{defaultValue:(r=e,null!=(a=Va.find((e=>e.value===r)))?a:Va[0]),showBeautifyBtn:Ua(e),options:Ha,onChange:t});var r,a}));var Ka=r(1590),Qa=r(85332);let Ya;const Ga=(0,a.lazy)((0,Ka.loadRemoteModule)("code-editor/CodeEditor")),Xa=c()(u.Z)(Ya||(Ya=(e=>e)`
  height: 100%;
...
`)),Ja=(0,o.observer)((function(){const[e]=za(),[t,r]=function(){const e=(0,f.x)(),t=(0,a.useRef)((t=>e.setRawEditorState({content:t})));return[e.rawEditorState.content,t.current]}(),s=(0,a.useRef)(null);_a((()=>{var e;null==(e=s.current)||e.beautifyContent()}));const o=(0,Qa.n)();return(0,D.jsx)(Xa,{height:"100%",children:(0,D.jsx)(a.Suspense,{fallback:(0,D.jsx)(i.Z,{}),children:(0,D.jsx)(Ga,{ref:e=>{e?(s.current=e,s.current.focus()):s.current=null},showNonPrintableCharacters:!0,fontSize:12,language:"json"===e?"postman_json":e,codeCompletionProviders:[{provider:o}],wordWrap:!0,value:t,onChange:r,autoFormat:!0})})})}));function es(){const[e,t]=(e=>{const{historyId:t}=(0,k.useParams)(),r=(0,f.x)(),s=(0,a.useRef)(((e,a)=>{(0,de.runInAction)((()=>{r.setRequestBodyState({activeBodyType:a}),"activeBodyType"===e&&"graphql"===a&&!t&&"GET"===r.method&&(r.method="POST",(0,n.Am)({title:"Request method changed",status:"info",description:"Request method has been changed to POST for the selected body type - GraphQL"}))}))}));return[e(r.requestBodyState),s.current]})((e=>e.activeBodyType)),r=(0,a.useRef)((e=>{t("activeBodyType",e)}));return[e,r.current]}const ts=[["none","none"],["params","form-data"],["urlencoded","x-www-form-urlencoded"],["raw","raw"],["binary","binary"],["graphql","GraphQL"]];let rs,as,ss=e=>e;const os=(0,a.lazy)((()=>r.e(7589).then(r.bind(r,37589)))),ns=c().nav(rs||(rs=ss`
...
`)),ls=e=>{const{bodyType:t}=e;switch(t){case"raw":return(0,D.jsx)(Wa,{});case"graphql":return(0,D.jsx)(a.Suspense,{fallback:(0,D.jsx)(D.Fragment,{children:" "}),children:(0,D.jsx)(os,{})});default:return(0,D.jsx)(is,{})}},ds=(0,o.observer)((function({bodyType:e}){const[,t]=es();return(0,D.jsx)(ns,{children:(0,D.jsxs)(u.Z,{gap:"spacing-s",children:[(0,D.jsx)(Aa.Z,{name:"workbench-request-body-group",value:e,onChange:t,children:ts.map((([e,t])=>(0,D.jsx)(La.Z,{value:e,id:e,label:t})))}),(0,D.jsx)(ls,{bodyType:e})]})})}));let cs;const us=c()(u.Z)(cs||(cs=(e=>e)`
  padding: var(--spacing-s) 0;
`)),hs=(0,o.observer)((function(){const[e,t,r]=function(){const e=(0,f.x)();return[e.binaryEditor.files,e.binaryEditor.processFiles,e.binaryEditor.resetFiles]}(),[s]=[(0,f.x)().binaryEditor.error],[o,n]=(0,a.useState)(!1),i=null==e?void 0:e.map((e=>e.path));return(0,D.jsx)(us,{height:"100%",width:"100%",children:(0,D.jsx)(ja.FileUploader,{label:"Select File",id:"request-body-binary",multiple:!1,value:i,loading:o,error:s,onChange:e=>{n(!0),t(e).finally((()=>n(!1)))},onReset:r})})})),ps=(0,o.observer)((function(){const[e,t]=function(){const e=(0,f.x)();return[e.formDataStore.items,e.formDataStore.setFormDataState]}(),[r]=[(0,f.x)().formDataStore.processFiles];return(0,D.jsx)(ja.KeyValueEditor,{enableFiles:!0,onFilesSelect:r,tableName:"Request Body Form Data",allowedColumns:["key","value"],showColumns:["key","value"],values:e,onChange:t,disableSorting:!1,nonEditableKeys:!1,nonEditableValues:!1,nonEditableToggles:!1,disableBulkEdit:!0,enableVariableSuggestions:!0})}));function ms(){return(0,D.jsx)(u.Z,{height:"100%",justifyContent:"center",alignItems:"center",children:(0,D.jsx)(h.ZP,{type:"body-medium",color:"content-color-tertiary",children:"This request does not have a body"})})}const gs=(0,o.observer)((()=>{const[e,t]=(()=>{const e=(0,f.x)();return[e.urlEncodedDataStore.items,e.urlEncodedDataStore.setFormDataState]})();return(0,D.jsx)(ja.KeyValueEditor,{tableName:"Request Body URL Encoded",allowedColumns:["key","value"],showColumns:["key","value"],values:e,onChange:e=>t(e),disableSorting:!1,nonEditableKeys:!1,nonEditableValues:!1,nonEditableToggles:!1,disableBulkEdit:!0,enableVariableSuggestions:!0})}));var vs=r(49437),bs=r(80047);let fs;const ys=c()(u.Z)(fs||(fs=(e=>e)`
  overflow: hidden;
`));function xs({description:e}){return(0,D.jsx)(ys,{direction:"column",height:"100%",justifyContent:"center",alignItems:"center",children:(0,D.jsx)(vs.Z,{title:"Coming Soon",description:e,children:(0,D.jsx)(bs.Z,{name:"illustration-no-custom-domain"})})})}const ks=(0,a.lazy)((()=>Promise.all([r.e(355),r.e(9513)]).then(r.bind(r,89513))));function Ss(e){if(!e.bodyType)return null;switch(e.bodyType){case"raw":return(0,D.jsx)(Ja,{});case"urlencoded":return(0,D.jsx)(gs,{});case"params":return(0,D.jsx)(ps,{});case"none":return(0,D.jsx)(ms,{});case"binary":return(0,D.jsx)(hs,{});case"graphql":return(0,D.jsx)(a.Suspense,{fallback:(0,D.jsx)(i.Z,{}),children:(0,D.jsx)(ks,{})});default:{var t;const[,r]=null!=(t=ts.find((([t])=>t===e.bodyType)))?t:ts[0];return(0,D.jsx)(xs,{description:`Support for ${r} in request body is coming soon.`})}}}let ws;const js=c().div(ws||(ws=(e=>e)`
  display: flex;
  flex-direction: column;
  flex: 1;
  overflow: auto;
`)),Ts=(0,o.observer)((function(){const[e]=es();return(0,D.jsxs)(u.Z,{direction:"column",height:"100%",children:[(0,D.jsx)(ds,{bodyType:e}),(0,D.jsx)(js,{role:"tabpanel","aria-labelledby":e,children:(0,D.jsx)(Ss,{bodyType:e})})]})}));var Cs=r(33105),Es=r(36166);let Is,qs,Ps=e=>e;const Rs=c()(p.Z)(Is||(Is=Ps`
  margin: var(--spacing-s) 0;
`)),Zs=c().div(qs||(qs=Ps`
  flex: 1;
  overflow: auto;
`)),Ds=(0,o.observer)((function(){const[e,t]=Kr(),[r]=[(0,f.x)().headerData.systemHeaders],[s,o]=(()=>{const e=(0,f.x)();return[e.headerData.systemHeadersHidden,e.headerData.setSystemHeadersHidden]})(),n=(0,a.useMemo)((()=>s?e.filter((e=>!r.includes(e))):e),[e,r,s]),i=s?{text:`${r.length} hidden`,icon:(0,D.jsx)(Cs.Z,{}),tooltip:"These headers will be automatically added and sent with the request. Click to view and modify these headers."}:{text:"Hide auto-generated headers",icon:(0,D.jsx)(Es.Z,{}),tooltip:"Click to hide these headers. They will still be automatically added and sent with the request."};return(0,D.jsxs)(Zs,{children:[(0,D.jsxs)(u.Z,{role:"heading",alignItems:"center",gap:"spacing-s",children:[(0,D.jsx)(h.ZP,{typographyStyle:{fontWeight:"text-weight-medium"},children:"Headers"}),(0,D.jsx)(Rs,(0,J.Z)({},i,{size:"small",onClick:()=>o(!s)}))]}),(0,D.jsx)(ja.KeyValueEditor,{tableName:"Request Headers",allowedColumns:["key","value"],showColumns:["key","value"],values:n,onChange:e=>{s&&(e=[...r,...e]),t(e)},disableSorting:!1,nonEditableKeys:!1,nonEditableValues:!1,nonEditableToggles:!1,disableBulkEdit:!0,disableMultilineKey:!0,disableMultilineValue:!0,enableVariableSuggestions:!0})]})}));var As=r(18767);const Ls=()=>{const e=(0,f.x)();return[e.requestAuthState,e.setRequestAuthState]};var zs=r(71453);let _s,Bs,Os=e=>e;const Fs=c()(u.Z)(_s||(_s=Os`
  width: 100%;
  height: 100%;
  align-items: center;
  justify-content: center;
...
`)),Tn=c()(ya.Z)(yn||(yn=wn`
  ...
  padding: ${0};
  width: 100%;
`),(e=>`${e.theme["spacing-zero"]} ${e.theme["spacing-s"]}`)),Cn=c()(ya.Z)(xn||(xn=wn`
  box-sizing: border-box;
  padding: ${0};
...
`),(e=>e.wordWrap&&e.theme["content-color-brand"])),ji=c()(u.Z)(ki||(ki=Si`
  padding: ${0};
`),(e=>e.theme["spacing-s"]));function Ti(e){const{wordWrap:t,setWordWrap:r,activeTab:s,onTabChange:o}=e,n=(0,ar.Z)(e,yi),[i,l]=(0,a.useState)(null!=s?s:ti.ll.PRETTY),d=i===ti.ll.PRETTY;i!==s&&s&&l(s);const c=[ti.ll.PRETTY,ti.ll.RAW].includes(i);return(0,D.jsxs)(ji,{direction:"row",gap:"spacing-s",children:[(0,D.jsx)(ai.y,{activeTabIndex:i,onChange:e=>{null==o||o(e),l(e)},type:"secondary",incrementallyCreateTabs:!0,destroyInactiveTabs:!0,children:(0,D.jsxs)(xa.Z,{children:[(0,D.jsx)(ka.Z,{label:"Pretty"}),(0,D.jsx)(ka.Z,{label:"Raw"}),(0,D.jsx)(ka.Z,{label:"Preview"})]})}),(0,D.jsxs)(u.Z,{justifyContent:"space-between",grow:"1",children:[(0,D.jsx)(u.Z,{gap:"spacing-s",children:d&&(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(fi,(0,J.Z)({},n)),(0,D.jsx)(wi,{type:"secondary",icon:(0,D.jsx)(ri.Z,{}),wordWrap:t,onClick:()=>r(!t)})]})}),(0,D.jsx)(pi,{enabled:c})]})]})}var Ci=r(64019),Ei=r(21180);let Ii,qi,Pi=e=>e;const Ri=(0,a.lazy)((0,Ka.loadRemoteModule)("code-editor/CodeEditor")),Zi=(0,a.lazy)((()=>r.e(8360).then(r.bind(r,58360)).then((e=>({default:e.ResponsePreviewPanel}))))),Di=c()(l.PaneContent)(Ii||(Ii=Pi`
  height: 100%;
`)),Ai=c().div(qi||(qi=Pi`
  height: 100%;
  padding: ${0};
`),(e=>`${e.theme["spacing-s"]}`)),Li=(e,t,r)=>{const a=[...e];return a[t]=r,a},zi=(0,o.observer)((()=>{const[e,t]=s().useState(!0),[,r]=hi(),o=(0,dr.j2)(),[n,l,d]=(0,dr.Sb)(),c=Ri,[u,h]=(0,a.useState)(ti.ll.PRETTY),[p,m]=(0,a.useState)([n,ti.B7.TEXT]);(0,a.useEffect)((()=>{m((e=>Li(e,ti.ll.PRETTY,n)))}),[n]);const g=(0,a.useCallback)((e=>m((t=>{if(u===ti.ll.PRETTY)l(e);else if(u===ti.ll.RAW)return Li(t,u,e);return t}))),[u,l]),v=p[u];let b;return b=u===ti.ll.PREVIEW?(0,D.jsx)(a.Suspense,{fallback:(0,D.jsx)(i.Z,{}),children:(0,D.jsx)(Zi,{})}):(0,D.jsx)(a.Suspense,{fallback:(0,D.jsx)(i.Z,{}),children:(0,D.jsx)(c,{language:null==v?void 0:v.toLowerCase(),wordWrap:e,readOnly:!0,enableLinks:!0,value:o,ref:r,autoFormat:!0})}),(0,D.jsxs)(Di,{children:[(0,D.jsx)(Ti,{wordWrap:e,setWordWrap:t,activeTab:u,onTabChange:h,language:v,onLangaugeSelect:g,onLanguageReset:()=>g(d)}),(0,D.jsx)(Ai,{children:b})]})})),_i=(0,o.observer)((function(){const[e]=(0,dr.Ik)(),t=(0,Ci.n)(null==e?void 0:e.mimeType);return(0,D.jsx)(Ei.CustomErrorBoundary,{appId:"http-workbench",errorElementId:"code-editor-provider",children:(0,D.jsx)(ui,{children:t?(0,D.jsx)(a.Suspense,{fallback:(0,D.jsx)(i.Z,{}),children:(0,D.jsx)(Zi,{})}):(0,D.jsx)(zi,{})})})}));let Bi;const Oi=c()(u.Z)(Bi||(Bi=(e=>e)`
  overflow: hidden;
`)),Fi=()=>(0,D.jsx)(Oi,{height:"calc(100% - var(--spacing-xxl))",alignItems:"center",children:(0,D.jsx)(vs.Z,{description:ti.Ei,children:(0,D.jsx)(bs.Z,{name:"illustration-hit-send"})})}),Mi=r.p+"failed-request.dfb3897ba46b8e21cd9a7434584860fe.svg";let $i,Ni,Vi,Hi,Ui,Wi=e=>e;const Ki=c()(u.Z)($i||($i=Wi`
