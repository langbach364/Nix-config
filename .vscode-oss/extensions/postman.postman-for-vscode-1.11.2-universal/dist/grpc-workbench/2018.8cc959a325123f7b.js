...
`)),Mo=i().div(Ro||(Ro=Po`
  ...
  align-items: center;
  gap: 0 var(--spacing-s);
`)),qo=(0,g.observer)((function(){const e=(0,Gt.Z)(),[t,r]=(0,Jt.Z)(),[o]=Kt(),s=(0,n.useRef)(null),a=(0,m.Z)().endStreaming,i=(()=>{const e=(0,m.Z)(),t=(0,Gt.Z)(),[r]=(0,Jt.Z)(),o=Bt(t);return()=>{try{o(r),e.sendStreamingMessage()}catch(e){u.Toast.getToasts().addToast({status:"error",description:e.message})}}})(),c=ne(),d=(0,n.useMemo)((()=>c&&o),[c,o]),p=(0,n.useMemo)((()=>({validate:!0,schemas:[{uri:(0,f.v4)(),schema:(0,Zo.toJS)(e)||{}}]})),[e]);return(0,I.jsxs)(l.Z,{direction:"column",height:"100%",children:[(0,I.jsx)(Oo,{children:(0,I.jsx)(n.Suspense,{fallback:(0,I.jsx)(Ce.Z,{}),children:(0,I.jsx)(Do.Provider,{value:{markName:ro,callback:Io},children:(0,I.jsx)(No,{ref:s,fontSize:12,language:"json",wordWrap:!0,placeholder:"Compose message",value:t,onChange:r,autoFormat:!0,settings:p})})})}),(0,I.jsxs)(Ao,{children:[(0,I.jsxs)(Mo,{children:[(0,I.jsx)(b.Z,{type:"tertiary",icon:(0,I.jsx)(wo.Z,{}),tooltip:"Beautify",onClick:()=>{var e;return null==(e=s.current)?void 0:e.beautifyContent()}}),e&&(0,I.jsx)(n.Suspense,{fallback:(0,I.jsx)(I.Fragment,{children:" "}),children:(0,I.jsx)(To,{})})]}),o&&(0,I.jsxs)(Mo,{children:[(0,I.jsx)(b.Z,{text:"End Streaming",onClick:a,isDisabled:!d,tooltip:d?"":"Invoke the method to send messages"}),(0,I.jsx)(Lo,{type:d?"primary":"secondary",onClick:i,isDisabled:!d,text:"Send"})]})]})]})}));var zo=r(68206),$o=r(81410);let Fo,_o,Uo,Wo=e=>e;const Vo=i()(zo.Z)(Fo||(Fo=Wo`
  &:not(:focus) {
