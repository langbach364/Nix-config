...
`),Z),G=v().div(P||(P=b`
  ...
  align-items: center;
  height: var(--size-m);
`)),z=({activeWorkspace:e,isOpen:r,setIsOpen:t})=>(0,W.jsx)(_,{onClick:()=>t(!r),children:void 0===e?(0,W.jsx)(j.Z,{height:"var(--size-m)",alignItems:"center",justifyContent:"center",children:(0,W.jsx)(S.Z,{})}):function(){const t=(null==e?void 0:e.name)||"Select Workspace";return(0,W.jsx)(N,{role:"menu",children:(0,W.jsxs)(G,{children:[(0,W.jsx)(y.ZP,{isTruncated:!0,children:t}),r?(0,W.jsx)(L,{color:"content-color-primary"}):(0,W.jsx)(R,{color:"content-color-primary"})]})})}()});var F=t(856),D=t(6417),H=t(605),U=t(5869),q=t(9245);let K,$,V,Y,B=e=>e;const J=v()(j.Z)(K||(K=B`
  align-items: center;
...
`)),Pe=({searchText:e,setSearchText:r,workspacesSectionProps:t})=>{const{errorLoading:n,numberOfWorkspaces:a}=t;return n&&!a?(0,W.jsx)(Ie,{}):(0,W.jsxs)(W.Fragment,{children:[(0,W.jsx)(re,{searchText:e,setSearchText:r}),(0,W.jsx)(se,{children:(0,W.jsx)(Me,(0,s.Z)({},t))})]})},be=e=>{const{isOpen:r,setIsOpen:t,trigger:a}=e,o=(0,n.useRef)(null);return(0,W.jsxs)(W.Fragment,{children:[(0,W.jsx)("div",{ref:o,children:a}),(0,W.jsx)(Oe,{isOpen:r,padding:"spacing-zero",placement:"bottom-end",onClickOutside:()=>t(!1),triggerRef:o,children:(0,W.jsx)(Pe,(0,s.Z)({},e))})]})},Ne=({Trigger:e,isOpen:r,setIsOpen:t,className:o})=>{const i=(0,a.useActiveWorkspaceId)(),[c,l]=(0,n.useState)(""),{data:u=[],refetch:h,refetching:f}=d(),{workspaces:x=[],hasMore:v,loadMore:k,error:y,fetchingNextPage:j,refetch:S}=p(u),{loading:E,workspaces:T=[],hasMore:C,loadMore:M,fetchingNextPage:I,error:A}=(({searchText:e})=>{const r=(0,n.useRef)(null),[t,a]=(0,n.useState)(null),[o,i]=(0,n.useState)(!1),[c,l]=(0,n.useState)(!1),[d,u]=(0,n.useState)(null),p=(0,n.useMemo)((()=>!(null==t||!t.meta.nextCursor)),[null==t?void 0:t.meta.nextCursor]);(0,n.useEffect)((()=>(e?(u(null),i(!0),r.current&&clearTimeout(r.current),r.current=setTimeout((()=>{a(null),g(e).then((({response:e,error:r})=>{a(e),i(!1),u(r)}))}),400)):(u(null),i(!1),a(null)),()=>{r.current&&clearTimeout(r.current)})),[e]);const h=(0,n.useCallback)((async()=>{if(!p)return!1;u(null),l(!0);const{response:r,error:n}=await g(e,null==t?void 0:t.meta.nextCursor);return r&&t&&a((0,s.Z)({},t,{meta:(0,s.Z)({},t.meta,r.meta),data:[...t.data,...r.data]})),l(!1),u(n),!(null==r||!r.meta.nextCursor)}),[p,e,t]),f=(0,n.useMemo)((()=>(null==t?void 0:t.data)||[]),[t]);return{loading:o,fetchingNextPage:c,loadMore:h,hasMore:p,workspaces:f,error:d}})({searchText:c}),{workspaceInfo:O,fetchWorkspaceInfo:P}=(()=>{const[e,r]=(0,n.useState)(null),[t,s]=(0,n.useState)(null),{data:o,isLoading:i,isError:c,refetch:l}=(0,a.useWorkspace)(e);(0,n.useEffect)((()=>{o&&s(o)}),[o]);const d=(0,n.useCallback)((e=>{r(e)}),[]);return{workspaceInfo:t,isLoading:i,isError:c,refetch:l,fetchWorkspaceInfo:d}})(),b=null===u,[N,_]=(0,n.useState)(window.INITIAL_WORKSPACE?JSON.parse(window.INITIAL_WORKSPACE||"null"):void 0),Z=(0,a.useNavigateToWorkspace)(),R=(0,n.useCallback)((e=>{l(""),t(!1),Z((null==e?void 0:e.id)||null),_(e)}),[t,Z]);(({activeWorkspace:e,setActiveWorkspace:r})=>{const{data:t,error:s}=d(),{workspaces:o,error:i}=p(),c=!t&&!s,l=!t&&!i,u=(0,a.useActiveWorkspaceId)();(0,n.useEffect)((()=>{if(null!=e&&e.id)return;if(!u)return r(null);const s=null==t?void 0:t.find((e=>e.id===u));if(s)return r(s);const n=null==o?void 0:o.find((e=>e.id===u));return n?r(n):c||l?void 0:r(null)}),[u,null==e?void 0:e.id,r,t,c,o,l])})({activeWorkspace:N,setActiveWorkspace:_}),(0,n.useEffect)((()=>{P(i)}),[i]),(0,n.useEffect)((()=>{O&&(_(O),m({workspaceId:i}))}),[O]),(0,n.useEffect)((()=>{i&&m({workspaceId:i})}),[i]),((e,r,t)=>{const s=(0,n.useRef)(!1);(0,n.useEffect)((()=>{s.current&&r(),e&&(s.current=!0)}),t)})(r,(()=>{r&&(f&&b||h(),y&&S())}),[r]);const L=(0,n.useMemo)((()=>[{type:"SECTION_HEADING",heading:"Recently Visited"},...null!=u&&u.length?u:[{type:"NO_WORKSPACES_FOUND_MESSAGE"}],{type:"SECTION_HEADING",heading:"More Workspaces"},...null!=x&&x.length?x:[{type:"NO_WORKSPACES_FOUND_MESSAGE"}]]),[u,x]),G=(0,n.useMemo)((()=>((null==u?void 0:u.length)||0)+((null==x?void 0:x.length)||0)),[null==u?void 0:u.length,null==x?void 0:x.length]),F=(0,n.useMemo)((()=>{const e={isOpen:r,onWorkspaceClick:R};return c?(0,s.Z)({},e,{numberOfWorkspaces:(null==T?void 0:T.length)||0,isSearchMode:!0,items:T||[],loading:E,fetchingNextPage:I,loadMore:M,hasMore:C,errorLoading:A}):(0,s.Z)({},e,{numberOfWorkspaces:G,items:L,loading:null===u||null===x,fetchingNextPage:j,hasMore:v,loadMore:k,errorLoading:y})}),[r,c,R,M,G,L,x,u,T,C,v,k,j,I,y,A,E]),D=e?(0,W.jsx)(e,{activeWorkspace:N,isOpen:r,setIsOpen:t}):(0,W.jsx)(z,{isOpen:r,setIsOpen:t,activeWorkspace:N});return(0,W.jsx)(w,{className:o,children:(0,W.jsx)(be,{isOpen:r,setIsOpen:t,trigger:D,searchText:c,setSearchText:l,workspacesSectionProps:F})})}}}]);
//# sourceMappingURL=5627.718cfe22b813228d.js.map