...
`),172,(e=>e.$isActive&&(0,O.css)(Ve||(Ve=_e`
      &::before {
        content: '';
        position: absolute;
        bottom: 0;
    ...
    `)))),We=I()(o.Link)(Ne||(Ne=_e`
  position: relative;
  display: flex;
  width: ${0};
  flex: 1;
`),(e=>e.width)),Fe=I().div(He||(He=_e`
  width: 100%;
  display: flex;
  gap: 0.5rem;
  align-items: center;
  ...
  ${0}
`),(e=>e.$isPreviewTab?"italic":""),(e=>e.$isDirty&&(0,O.css)(Se||(Se=_e`
      .tab-close-icon {
        display: none;
      }
...
`)),Qe=e=>null!=e&&e.isConflicted?"[CONFLICT] ":"",Ke=e=>{const{activeTab:t,setActiveTab:n,closeTab:r,setTabsMeta:l,tabsMeta:o}=b(),c=t===e.tab.id,d=o[e.tab.id],u=(null==d?void 0:d.currentlyActiveURL)||e.tab.pathname,v=y(e.tab,o),h=(0,i.useCallback)((t=>(t.preventDefault(),t.stopPropagation(),r(e.tab.id),null)),[r,e.tab.id]),p=(0,i.useCallback)((()=>{l((t=>(0,a.Z)({},t,{[e.tab.id]:(0,a.Z)({},d,{isPinned:!0})})))}),[e.tab.id,d,l]);return(0,s.jsx)(Ue,{$isActive:c,children:(0,s.jsx)(We,{width:e.width,to:u,onClick:t=>{!c&&n(e.tab.id),c&&t.preventDefault(),c&&t.stopPropagation()},state:{navigationParams:{tabId:e.tab.id}},onContextMenu:e.onContextMenu,children:(0,s.jsxs)(Fe,{className:"tab-title-container",$isActive:c,$isDirty:null==d?void 0:d.isDirty,$isPreviewTab:v,onDoubleClick:p,"data-testid":"tab-header",children:[(0,s.jsx)(ze,{children:fe[null==d?void 0:d.tabType]||fe.default}),(0,s.jsxs)(qe,{title:(null==d?void 0:d.title)||"Loading...",children:[Qe(d),(null==d?void 0:d.title)||"Loading..."]}),(0,s.jsxs)(Je,{onClick:h,"data-testid":"tab-close-icon",children:[(null==d?void 0:d.isDirty)&&(0,s.jsx)(Xe,{className:"dirty-indicator"}),(0,s.jsx)(Ye,{className:"tab-close-action",children:(0,s.jsx)(P.Z,{className:"tab-close-icon",type:"tertiary",size:"small",icon:(0,s.jsx)(Me.Z,{})})})]}),(0,s.jsx)(Ge,{})]})},e.tab.id)})};let et,tt,nt=e=>e;const rt=I().div(et||(et=nt`
