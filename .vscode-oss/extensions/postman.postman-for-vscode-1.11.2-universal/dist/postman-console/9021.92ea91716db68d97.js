...
`),172,(e=>e.$isActive&&(0,I.css)(_e||(_e=Qe`
      &::before {
        content: '';
        position: absolute;
        bottom: 0;
    ...
    `)))),et=O()(o.Link)(Ue||(Ue=Qe`
  position: relative;
  display: flex;
  width: ${0};
  flex: 1;
`),(e=>e.width)),tt=O().div(We||(We=Qe`
  width: 100%;
  display: flex;
  gap: 0.5rem;
  align-items: center;
  ...
  ${0}
`),(e=>e.$isPreviewTab?"italic":""),(e=>e.$isDirty&&(0,I.css)(Fe||(Fe=Qe`
      .tab-close-icon {
        display: none;
      }
...
`)),st=e=>null!=e&&e.isConflicted?"[CONFLICT] ":"",ct=e=>{const{activeTab:t,setActiveTab:n,closeTab:a,setTabsMeta:l,tabsMeta:o}=v(),c=t===e.tab.id,d=o[e.tab.id],u=(null==d?void 0:d.currentlyActiveURL)||e.tab.pathname,b=y(e.tab,o),h=(0,i.useCallback)((t=>(t.preventDefault(),t.stopPropagation(),a(e.tab.id),null)),[a,e.tab.id]),p=(0,i.useCallback)((()=>{l((t=>(0,r.Z)({},t,{[e.tab.id]:(0,r.Z)({},d,{isPinned:!0})})))}),[e.tab.id,d,l]);return(0,s.jsx)(Ke,{$isActive:c,children:(0,s.jsx)(et,{width:e.width,to:u,onClick:t=>{!c&&n(e.tab.id),c&&t.preventDefault(),c&&t.stopPropagation()},state:{navigationParams:{tabId:e.tab.id}},onContextMenu:e.onContextMenu,children:(0,s.jsxs)(tt,{className:"tab-title-container",$isActive:c,$isDirty:null==d?void 0:d.isDirty,$isPreviewTab:b,onDoubleClick:p,"data-testid":"tab-header",children:[(0,s.jsx)(nt,{children:Ze[null==d?void 0:d.tabType]||Ze.default}),(0,s.jsxs)(at,{title:(null==d?void 0:d.title)||"Loading...",children:[st(d),(null==d?void 0:d.title)||"Loading..."]}),(0,s.jsxs)(rt,{onClick:h,"data-testid":"tab-close-icon",children:[(null==d?void 0:d.isDirty)&&(0,s.jsx)(it,{className:"dirty-indicator"}),(0,s.jsx)(lt,{className:"tab-close-action",children:(0,s.jsx)(P.Z,{className:"tab-close-icon",type:"tertiary",size:"small",icon:(0,s.jsx)(Pe,{})})})]}),(0,s.jsx)(ot,{})]})},e.tab.id)})};let dt,ut,bt=e=>e;const vt=O().div(dt||(dt=bt`
...
`),90),ht=O().div(ut||(ut=bt`
  ...
  padding: 0 var(--spacing-xs);
  gap: var(--spacing-xs);
`)),pt=()=>{const{tabs:e}=v(),[t,n]=(0,i.useState)({open:!1}),{workspaceId:a}=(0,o.useParams)(),r=R(),l=(0,i.useCallback)((()=>{if(!a)return;const e=(0,g.v4)();r(`/workspace/${a}/request/create?requestId=${e}`,{},{newTab:!0,customNavEvent:"VIEW_COLLECTION_FOLDER_REQUEST"})}),[a,r]),c=(0,i.useCallback)(((e,t)=>{t.preventDefault(),n({open:!0,forTabId:e,position:{x:t.pageX,y:t.pageY}})}),[]),d=(0,i.useCallback)((()=>n({open:!1})),[]),u=(0,i.useCallback)((t=>e.map((e=>(0,s.jsx)(ct,{width:t,tab:e,onContextMenu:t=>c(e.id,t)},e.id)))),[e,c]);return(0,s.jsxs)(vt,{children:[(0,s.jsx)(Ae,{minWidth:90,maxWidth:172,tabsCount:e.length,renderTabs:u,rightActions:(0,s.jsx)(P.Z,{type:"tertiary",icon:(0,s.jsx)(W,{}),onClick:l})}),(0,s.jsx)(Q,{isOpen:null==t?void 0:t.open,forTabId:null==t?void 0:t.forTabId,position:null==t?void 0:t.position,closeMenu:d,createNewRequest:l}),(0,s.jsx)(ht,{children:(0,s.jsx)(Le,{})})]})};var ft=n(22833),mt=n.n(ft);let Ct;const gt=O().div(Ct||(Ct=(e=>e)`
  display: ${0};
  height: var(--wp-workbench-height);
`),(({$isHidden:e})=>e?"none":"block")),xt=e=>{const t=!f();return m(),(0,s.jsx)(gt,{className:mt()({"tab-content":!0,"is-hidden":t}),$isHidden:t,children:e.children})},wt=({tab:e})=>{const{tabsMeta:t}=v(),n=Z(e),a=L(e),r=(0,i.useMemo)((()=>{var r,i,l,o;return{tabId:e.id,pathname:e.pathname,isDirty:null==(r=t[e.id])?void 0:r.isDirty,isConflicted:null==(i=t[e.id])?void 0:i.isConflicted,title:(null==(l=t[e.id])?void 0:l.title)||"",tabType:(null==(o=t[e.id])?void 0:o.tabType)||"http",setTabTitle:a,setTabState:n}}),[e.id,e.pathname,t,a,n]);return(0,s.jsx)(h.Provider,{value:r,children:(0,s.jsx)(xt,{children:e.element},e.pathname)})},yt=({fallback:e})=>{const{tabs:t}=v();return(0,i.useMemo)((()=>(0,s.jsxs)(s.Fragment,{children:[0===t.length&&e?e:"",t.map((e=>(0,s.jsx)(wt,{tab:e},e.pathname)))]})),[t,e])},Tt=({children:e})=>(T(),C(),(0,s.jsxs)(s.Fragment,{children:[e," "]})),Zt="tab-close-confirmation-modal",Lt=e=>`This tab ${e||"Untitled tab"} has unsaved changes which will be lost if you choose to close it. Save these changes to avoid losing your work.`,kt=[{title:"Don't Save",isDefaultOnDismiss:!0},{title:"Cancel",isPrimary:!0}],Et="tab-force-close-confirmation-modal",jt=e=>`${e} tab${1===e?" has":"s have"} unsaved changes. Your changes will be lost if you force close this tab. Are you sure you want to force close?`,Mt=[{title:"Cancel",isDefaultOnDismiss:!0},{title:"Force Close",isPrimary:!0}],Bt=(e,t)=>{var n;return null==(n=t[e])?void 0:n.isDirty},Rt=async(e,t)=>{const n=await e.showWarningDialog({uid:Zt,subject:"DO YOU WANT TO SAVE?",message:Lt(t),options:kt});return!n||"Cancel"!==n.title},Vt=({fallback:e})=>{const t=R(),n=(0,o.useMatches)(),a=A.Modals.getModals(),[r,l]=(0,i.useState)(null),[c,d]=(0,i.useState)([]),[u,v]=(0,i.useState)({}),[h,p]=(0,i.useState)([]),f=(0,i.useCallback)((e=>{var n;l(e.id),t((null==(n=u[e.id])?void 0:n.currentlyActiveURL)||e.pathname)}),[t,u]),m=(0,i.useCallback)((e=>{e&&p((t=>{var n,a,r;return[...t,{id:e.id,pathname:(null==(n=u[e.id])?void 0:n.currentlyActiveURL)||e.pathname,title:null==(a=u[e.id])?void 0:a.title,tabType:null==(r=u[e.id])?void 0:r.tabType}]}))}),[u]),C=(0,i.useCallback)((e=>p((t=>[...t].splice(e,1)))),[]),g=(0,i.useCallback)((e=>{const n=h[e];t(n.pathname,{},{newTab:!0,customNavEvent:"VIEW_COLLECTION_FOLDER_REQUEST"}),C(e)}),[C,t,h]),x=(0,i.useCallback)((async(e,i=!1)=>{var l;const o=c.findIndex((t=>t.id===e));if(-1===o)return;const s=c[o],b=Bt(s.id,u);if(!i&&b&&!await Rt(a,null==(l=u[e])?void 0:l.title))return;if(s.id===r){const e=((e,t)=>{const n=t-1;return e[t+1]||e[n]})(c,o);if(e)f(e);else{const e=n.at(-2);(null==e?void 0:e.pathname)&&t(e.pathname)}}const v=c.filter((t=>t.id!==e));d(v),m(s)}),[t,f,c,n,u,a,r,m]),w=(0,i.useCallback)((async(e=!1)=>{if(e){const e=c.filter((e=>Bt(e.id,u))).length;if(e&&!await(async(e,t)=>{const n=await e.showWarningDialog({uid:Et,subject:"Confirm force close",message:jt(t),options:Mt});return!n||"Cancel"!==n.title})(a,e))return;for(const e of c)m(e);d([]);const r=n.at(-2);return(null==r?void 0:r.pathname)&&t(r.pathname)}const r=[];for(const e of c){var i;Bt(e.id,u)&&!await Rt(a,null==(i=u[e.id])?void 0:i.title)||(m(e),r.push(e.id))}d((e=>e.filter((e=>!r.includes(e.id)))))}),[c,a,n,t,u,m]),y=(0,i.useCallback)((async(e=r)=>{const t=[];for(const r of c){var n;r.id!==e&&(Bt(r.id,u)&&!await Rt(a,null==(n=u[r.id])?void 0:n.title)||t.push(r.id))}d((e=>e.filter((e=>!t.includes(e.id)))))}),[r,c,a,u]),T=(0,i.useMemo)((()=>({tabs:c,setTabs:d,tabsMeta:u,setTabsMeta:v,recentlyClosed:h,closeTab:x,closeAllTabs:w,activeTab:r,setActiveTab:l,closeAllNonSelectedTabs:y,openFromRecentlyClosed:g})),[c,u,h,x,r,l,w,y,g]);return(0,s.jsx)(b.Provider,{value:T,children:(0,s.jsxs)(Tt,{children:[(0,s.jsx)(A.Modals.Ui.ModalDialog,{uid:Zt}),(0,s.jsx)(A.Modals.Ui.ModalDialog,{uid:Et}),(0,s.jsx)(pt,{}),(0,s.jsx)(yt,{fallback:e})]})})};var Nt,Ht=n(47291);const St=null==(Nt=window)||null==(Nt=Nt.location)?void 0:Nt.pathname,Dt=(localStorage.getItem("lastVisitedRoute"),()=>{let e="/";try{var t;e=JSON.parse(null==(t=window)?void 0:t.NAVIGATION_CONTEXT).to}catch(e){console.error("Failed to parse NAVIGATION_CONTEXT")}return e}),At=(e,t)=>{const n=[{opts:{initialEntries:[Dt()],initialIndex:0},router:(0,Ht.sentryRouter)(o.createMemoryRouter)},(0,Ht.sentryRouter)(window.HOST_APP_NAME?o.createBrowserRouter:o.createMemoryRouter),(0,Ht.sentryRouter)(o.createMemoryRouter)][0];return{platformRouterConfig:n,router:n.router(e,(0,r.Z)({},n.opts,t))}}}}]);
//# sourceMappingURL=9021.92ea91716db68d97.js.map