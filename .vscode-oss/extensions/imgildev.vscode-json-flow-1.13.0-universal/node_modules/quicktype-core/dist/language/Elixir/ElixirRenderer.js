...
class ElixirRenderer extends ConvenienceRenderer_1.ConvenienceRenderer {
    ...
    forbiddenNamesForGlobalNamespace() {
        return [...constants_1.forbiddenModuleNames, ...constants_1.reservedWords.map(word => (0, utils_1.capitalizeFirstLetter)(word))];
    }
    forbiddenForObjectProperties(_c, _classNamed) {
        return { names: constants_1.reservedWords, includeGlobalForbidden: true };
    }
    makeNamedTypeNamer() {
            ...
            this.emitBlock([`def to_map(${isEmpty ? "_" : ""}struct) do`], () => {
                ...
                this.indent(() => {
                    this.forEachClassProperty(c, "none", (name, jsonName, p) => {
                        ...
                        this.emitLine([[`"${(0, utils_1.stringEscape)(jsonName)}"`], [" => ", expression, ","]]);
                    });
                });
                this.emitLine("}");
            });
