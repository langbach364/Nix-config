...
class SystemTextJsonCSharpRenderer extends CSharpRenderer_1.CSharpRenderer {
    ...
    emitUsings() {
        ...
        if (this._options.dense) {
            this.emitUsing([utils_1.denseJsonPropertyName, " = System.Text.Json.Serialization.JsonPropertyNameAttribute"]);
            // this.emitUsing([denseRequiredEnumName, " = Newtonsoft.Json.Required"]);
            this.emitUsing([utils_1.denseNullValueHandlingEnumName, " = System.Text.Json.Serialization.JsonIgnoreCondition"]);
        }
