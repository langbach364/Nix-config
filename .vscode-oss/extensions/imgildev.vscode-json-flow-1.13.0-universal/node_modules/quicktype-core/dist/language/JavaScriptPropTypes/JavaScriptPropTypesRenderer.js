...
class JavaScriptPropTypesRenderer extends ConvenienceRenderer_1.ConvenienceRenderer {
    ...
    typeMapTypeFor(t, required = true) {
        ...
        const match = (0, TypeUtils_1.matchType)(t, _anyType => "PropTypes.any", _nullType => "PropTypes.any", _boolType => "PropTypes.bool", _integerType => "PropTypes.number", _doubleType => "PropTypes.number", _stringType => "PropTypes.string", arrayType => ["PropTypes.arrayOf(", this.typeMapTypeFor(arrayType.items, false), ")"], _classType => (0, Support_1.panic)("Should already be handled."), _mapType => "PropTypes.object", _enumType => (0, Support_1.panic)("Should already be handled."), unionType => {
