...
class CJSONRenderer extends ConvenienceRenderer_1.ConvenienceRenderer {
    ...
    forbiddenNamesForGlobalNamespace() {
        return [...constants_1.keywords, ...this.forbiddenGlobalNames];
    }
    /**
                                ...
                                this.emitBlock([
                                    ...
                                    const add = (cJSON, level, child_level) => {
                                        ...
                                        if (((_a = cJSON.items) === null || _a === void 0 ? void 0 : _a.cjsonType) === "cJSON_Array") {
                                            ...
                                            (_q = cJSON.items) === null || _q === void 0 ? void 0 : _q.cType, " * tmp", level > 0 ? level.toString() : "", " = cJSON_malloc(sizeof(", (_r = cJSON.items) === null || _r === void 0 ? void 0 : _r.cType, "));");
                    ...
                    this.emitBlock([onFirst === true ? "if (" : "else if (", cJSON.cjsonType, " == x->type)"], () => {
                        if (cJSON.cjsonType === "cJSON_Array" && cJSON.items !== undefined) {
                            ...
                            this.emitBlock(["if (NULL != j", child_level.toString(), ")"], () => {
                                ...
                                this.emitLine(
                                // @ts-expect-error awaiting refactor
                                (_a = cJSON.items) === null || _a === void 0 ? void 0 : _a.cType, " * x", child_level.toString(), " = list_get_head(x", level > 0 ? level.toString() : "", "->value.", this.nameForUnionMember(unionType, type), ");");
                            ...
                            this.emitBlock(["if (NULL != j", child_level.toString(), ")"], () => {
                                ...
                                this.emitBlock(["if (NULL != keys", child_level.toString(), ")"], () => {
                                    this.emitBlock([
                                        ...
                                        this.emitLine(
                                        // @ts-expect-error awaiting refactor
                                        (_a = cJSON.items) === null || _a === void 0 ? void 0 : _a.cType, " *x", child_level.toString(), " = hashtable_lookup(x", level > 0 ? level.toString() : "", "->value.", this.nameForUnionMember(unionType, type), ", keys", child_level.toString(), "[index", child_level.toString(), "]);");
                                        const add = (cJSON, child_level) => {
                                            var _a, _b, _d, _e, _f, _g, _h, _j, _k, _l;
                                            if (((_a = cJSON.items) === null || _a === void 0 ? void 0 : _a.cjsonType) === "cJSON_Array") {
                                                /* Not supported */
